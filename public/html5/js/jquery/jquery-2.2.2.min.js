...
!(function (a, b) {
                  ...
                  y(a, function (a) {
                    return b.test(
                      ('string' == typeof a.className && a.className) ||
                        ('undefined' != typeof a.getAttribute && a.getAttribute('className')) ||
                        ''
                    )
                  }))
              )
  ...
  var eb = /[\t\r\n\f]/g
  function fb(a) {
    return (a.getAttribute && a.getAttribute('className')) || ''
  }
  n.fn.extend({
    addClass: function (a) {
      var b,
      ...
      if ('string' == typeof a && a) {
        ...
        while ((c = this[i++]))
          if (((e = fb(c)), (d = 1 === c.nodeType && (' ' + e + ' ').replace(eb, ' ')))) {
            ...
            ;(h = n.trim(d)), e !== h && c.setAttribute('className', h)
          }
      }
      return this
    },
    ...
    toggleClass: function (a, b) {
      ...
      return 'boolean' == typeof b && 'string' === c
        ...
        : this.each(function () {
            ...
            } else (void 0 !== a && 'boolean' !== c) || ((b = fb(this)), b && N.set(this, '__className__', b), this.setAttribute && this.setAttribute('className', b || a === !1 ? '' : N.get(this, '__className__') || ''))
          })
    },
    hasClass: function (a) {
      var b,
