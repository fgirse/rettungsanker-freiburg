      ...
      $('img').preload(function (perc, done) {
        ...
        if (done) {
          ...
          if (options.timelineBorderWidth > 0) {
            ...
            wrapper.css(
              'border',
              options.timelineBorderWidth + 'px solid ' + options.timelineBorderColor
            )
          ...
          if (options.audioPlayer) {
            ...
            wrapper.append(
              '<audio className="audio_player" src="' + options.audioFilePath + '"></audio>'
            )
