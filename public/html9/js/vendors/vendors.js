  ...
  ;(t.cleanData = (function (e) {
    ...
    (t.widget = function (e, i, s) {
      ...
      return (
        ...
        t.extend(o, a, { version: s.version, _proto: t.extend({}, s), _childConstructors: [] }),
        (r = new i()),
                  ...
                  ? t.isFunction(n[a]) && '_' !== a.charAt(0)
                    ? ((i = n[a].apply(n, r)),
                      i !== n && void 0 !== i
                        ...
                        : void 0)
                    : t.error("no such method '" + a + "' for " + e + ' widget instance')
                  : t.error(
    ...
    (t.Widget.prototype = {
      ...
      option: function (e, i) {
        ...
        if ('string' == typeof e)
          if (((o = {}), (s = e.split('.')), (e = s.shift()), s.length)) {
            for (n = o[e] = t.widget.extend({}, this.options[e]), a = 0; s.length - 1 > a; a++)
              (n[s[a]] = n[s[a]] || {}), (n = n[s[a]])
      ...
      _on: function (e, i, s) {
        ...
        'boolean' != typeof e && ((s = i), (i = e), (e = !1)),
          ...
          t.each(s, function (s, o) {
            function r() {
              return e || (a.options.disabled !== !0 && !t(this).hasClass('ui-state-disabled'))
      ...
      _trigger: function (e, i, s) {
        ...
        return (
          ...
          !(
            (t.isFunction(o) && o.apply(this.element[0], [i].concat(s)) === !1) ||
  ...
  t(document).mouseup(function () {
          ...
          n.containment
            ? 'window' === n.containment
              ...
              ? ((this.containment = [
                  0,
                  0,
                  t(a).width() - this.helperProportions.width - this.margins.left,
    ...
    t.ui.plugin.add('draggable', 'scroll', {
      ...
      drag: function (e, i, s) {
        ...
        o !== r && 'HTML' !== o.tagName
          ? ((n.axis && 'x' === n.axis) ||
              (s.overflowOffset.top + o.offsetHeight - e.pageY < n.scrollSensitivity
                ? (o.scrollTop = a = o.scrollTop + n.scrollSpeed)
                : e.pageY - s.overflowOffset.top < n.scrollSensitivity &&
                  (o.scrollTop = a = o.scrollTop - n.scrollSpeed)),
            (n.axis && 'y' === n.axis) ||
              (s.overflowOffset.left + o.offsetWidth - e.pageX < n.scrollSensitivity
          ...
          (h = s.snapElements[d].left - s.margins.left),
            ...
            !t.contains(s.snapElements[d].item.ownerDocument, s.snapElements[d].item)
              ...
              : ('inner' !== f.snapMode &&
                  ...
                  a && (i.position.top = s._convertPositionTo('relative', { top: c, left: 0 }).top),
                  o &&
            ...
            f(a, function (e, i) {
              l.fn[e] ||
                (l.fn[e] = function (n) {
                  ...
                  return 'undefined' === o
                    ? u
                    : ('function' === o && ((n = n.call(this, u)), (o = t.type(n))),
                      null == n && i.empty
                        ? this
                        : ('string' === o &&
                            ((a = r.exec(n)),
          ...
          toggleClass: (function (e) {
            return function (i, s, n, a, o) {
              return 'boolean' == typeof s || void 0 === s
                ? n
                  ? t.effects.animateClass.call(this, s ? { add: i } : { remove: i }, n, a, o)
                  : e.apply(this, arguments)
      ...
      t.extend(t.effects, {
        ...
        restore: function (t, e) {
          ...
          for (s = 0; e.length > s; s++)
            null !== e[s] && ((i = t.data(o + e[s])), void 0 === i && (i = ''), t.css(e[s], i))
        },
...
//SHARED VARS
var ratio, ratioDragger, iScroll, iScroll2, iPosition, doresize, scroll_pos, dynamicScrollWidth
...
function Scrollbar(root, options) {
  ...
  this.update = function (sScroll) {
    ...
    oDragger[options.axis] = Math.min(
      ...
      Math.max(
        0,
        options.draggerWidth == 'auto' ? oTrack[options.axis] * oImages.ratio : options.draggerWidth
      )
    )
    ...
    iScroll =
      sScroll == 'relative' && oImages.ratio <= 1
        ? Math.min(oImages[options.axis] - oViewport[options.axis], Math.max(0, iScroll))
        : 0
    iScroll =
    ...
    iScroll2 =
      sScroll == 'relative' && oContent.ratio <= 1
        ? Math.min(oContent[options.axis] - oMilestones[options.axis], Math.max(0, iScroll2))
        : 0
    iScroll2 =
    ...
    if (oScrollbar.ratio < 0 && oScrollbar2.ratio < 0) $('.dragger').hide()
    else $('.dragger').show()
...
$.fn.player = function (settings) {
  ...
  var playControl = '<span className="simpleplayer-play-control"></span>'
  var stopControl = '<span className="simpleplayer-stop-control"></span>'

  this.each(function () {
    $(this)
      .wrap('<div className="simple-player-container" />')
      .parent()
      .prepend(
        '<div><ul>' +
          '<li style="display: inline-block; padding: 0 2px; "><a style="text-decoration: none;"' +
          ' className="start-button" href="javascript:void(0)">' +
          playControl +
          '</a></li>' +
          '</ul></div>'
      )
...
!(function (e) {
  ...
  ;(e.prettyPhoto = { version: '3.1.6' }),
    (e.fn.prettyPhoto = function (i) {
      function p() {
        e('.pp_loaderIcon').hide(),
          (projectedTop = scroll_pos.scrollTop + (k / 2 - g.containerHeight / 2)),
          ...
          $pp_pic_holder.animate(
            {
              top: projectedTop,
              left: $ / 2 - g.containerWidth / 2 < 0 ? 0 : $ / 2 - g.containerWidth / 2,
            ...
            function () {
              $pp_pic_holder
                ...
                isSet && 'image' == r(pp_images[set_position])
                  ? $pp_pic_holder.find('.pp_hoverContainer').show()
                  : $pp_pic_holder.find('.pp_hoverContainer').hide(),
                settings.allow_expand &&
                  (g.resized ? e('a.pp_expand,a.pp_contract').show() : e('a.pp_expand').hide()),
                !settings.autoplay_slideshow || w || m || e.prettyPhoto.startSlideshow(),
      ...
      function s(e, t) {
        if (
          ...
          (imageWidth = e),
          (imageHeight = t),
          (y > $ || v > k) && doresize && settings.allow_resize && !P)
        ) {
          for (resized = !0, fitting = !1; !fitting; )
            y > $
              ? ((imageWidth = $ - 200), (imageHeight = (t / e) * imageWidth))
              : v > k
              ? ((imageHeight = k - 200), (imageWidth = (e / t) * imageHeight))
              : (fitting = !0),
              (v = imageHeight),
              (y = imageWidth)
          ;(y > $ || v > k) && s(y, v), n(imageWidth, imageHeight)
        }
        return {
      ...
      function n(t, i) {
        ;(t = parseFloat(t)),
          ...
          $pp_details.width(t),
          (detailsHeight =
            parseFloat($pp_details.css('marginTop')) + parseFloat($pp_details.css('marginBottom'))),
      ...
      function l() {
        if (doresize && 'undefined' != typeof $pp_pic_holder) {
          ...
          $pp_pic_holder.css({
            top: projectedTop,
            left: $ / 2 + scroll_pos.scrollLeft - contentwidth / 2,
          })
        }
      }
      function d() {
      ...
      function h() {
        ;(k = e(window).height()),
          ($ = e(window).width()),
          'undefined' != typeof $pp_overlay && $pp_overlay.height(e(document).height()).width($)
      }
      function c() {
        isSet && settings.overlay_gallery && 'image' == r(pp_images[set_position])
          ? ((itemWidth = 57),
            (navWidth = 'facebook' == settings.theme || 'pp_default' == settings.theme ? 50 : 30),
            (itemsPerPage = Math.floor((g.containerWidth - 100 - navWidth) / itemWidth)),
      ...
      function _() {
        if (
          ...
          for (var t = 0; t < pp_images.length; t++)
            pp_images[t].match(/\b(jpg|jpeg|png|gif)\b/gi)
              ? ((classNamename = ''), (img_src = pp_images[t]))
              : ((classNamename = 'default'), (img_src = '')),
              (toInject +=
                "<li className='" +
                classNamename +
                "'><a href='#'><img src='" +
        ...
        settings.slideshow &&
          ...
          $pp_pic_holder.attr('className', 'pp_pic_holder ' + settings.theme),
          $pp_overlay
      ...
      i = jQuery.extend(
        {
          ...
          callback: function () {},
          markup:
            '<div className="pp_pic_holder"> 						<div className="ppt">&nbsp;</div> 						<div className="pp_top"> 							<div className="pp_left"></div> 							<div className="pp_middle"></div> 							<div className="pp_right"></div> 						</div> 						<div className="pp_content_container"> 							<div className="pp_left"> 							<div className="pp_right"> 								<div className="pp_content"> 									<div className="pp_loaderIcon"></div> 									<div className="pp_fade"> 										<a href="#" className="pp_expand" title="Expand the image">Expand</a> 										<div className="pp_hoverContainer"> 											<a className="pp_next" href="#">next</a> 											<a className="pp_previous" href="#">previous</a> 										</div> 										<div id="pp_full_res"></div> 										<div className="pp_details"> 											<div className="pp_nav"> 												<a href="#" className="pp_arrow_previous">Previous</a> 												<p className="currentTextHolder">0/0</p> 												<a href="#" className="pp_arrow_next">Next</a> 											</div> 											<p className="pp_description"></p> 											<div className="pp_social">{pp_social}</div> 											<a className="pp_close" href="#">Close</a> 										</div> 									</div> 								</div> 							</div> 							</div> 						</div> 						<div className="pp_bottom"> 							<div className="pp_left"></div> 							<div className="pp_middle"></div> 							<div className="pp_right"></div> 						</div> 					</div> 					<div className="pp_overlay"></div>',
          gallery_markup:
            '<div className="pp_gallery"> 								<a href="#" className="pp_arrow_previous">Previous</a> 								<div> 									<ul> 										{gallery} 									</ul> 								</div> 								<a href="#" className="pp_arrow_next">Next</a> 							</div>',
          image_markup: '<img id="fullResImage" src="{path}" />',
          flash_markup:
            '<object classNameid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="{width}" height="{height}"><param name="wmode" value="{wmode}" /><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="{path}" /><embed src="{path}" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="{width}" height="{height}" wmode="{wmode}"></embed></object>',
          quicktime_markup:
            '<object classNameid="clsid:02BF25D5-8C17-4B23-BC80-D3488ABDDC6B" codebase="http://www.apple.com/qtactivex/qtplugin.cab" height="{height}" width="{width}"><param name="src" value="{path}"><param name="autoplay" value="{autoplay}"><param name="type" value="video/quicktime"><embed src="{path}" height="{height}" width="{width}" autoplay="{autoplay}" type="video/quicktime" pluginspage="http://www.apple.com/quicktime/download/"></embed></object>',
          iframe_markup:
            '<iframe src ="{path}" width="{width}" height="{height}" frameborder="no"></iframe>',
          inline_markup: '<div className="pp_inline">{content}</div>',
          custom_markup: '',
          social_tools:
            '<div className="twitter"><a href="http://twitter.com/share" className="twitter-share-button" data-count="none">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></div><div className="facebook"><iframe src="//www.facebook.com/plugins/like.php?locale=en_US&href={location_href}&amp;layout=button_count&amp;show_faces=true&amp;width=500&amp;action=like&amp;font&amp;colorscheme=light&amp;height=23" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:500px; height:23px;" allowTransparency="true"></iframe></div>',
        },
        i
      )
      var g,
      ...
      return (
        ...
        (e.prettyPhoto.open = function (o) {
          return (
            ...
            (movie_width = parseFloat(t('width', pp_images[set_position]))
              ? t('width', pp_images[set_position])
              : settings.default_width.toString()),
            (movie_height = parseFloat(t('height', pp_images[set_position]))
              ? t('height', pp_images[set_position])
            ...
            $pp_pic_holder.fadeIn(function () {
              switch (
                ...
                case 'image':
                  ;(imgPreloader = new Image()),
                    ...
                    (imgPreloader.onload = function () {
                      ;(g = s(imgPreloader.width, imgPreloader.height)), p()
                    }),
                ...
                case 'youtube':
                  ;(g = s(movie_width, movie_height)),
                    ...
                    t('rel', pp_images[set_position])
                      ? (movie += '?rel=' + t('rel', pp_images[set_position]))
                      : (movie += '?rel=1'),
                  ...
                  break
                case 'vimeo':
                  ;(g = s(movie_width, movie_height)), (movie_id = pp_images[set_position])
                  var i = /http(s?):\/\/(www\.)?vimeo.com\/(\d+)/,
                    o = movie_id.match(i)
                  ;(movie =
                    ...
                    settings.autoplay && (movie += '&autoplay=1;'),
                    (vimeo_width = g.width + '/embed/?moog_width=' + g.width),
                    (toInject = settings.iframe_markup
                ...
                case 'ajax':
                  ...
                  break
                case 'custom':
                  ;(g = s(movie_width, movie_height)), (toInject = settings.custom_markup)
                  break
                case 'inline':
                  ;(myClone = e(pp_images[set_position])
                    ...
                    .wrapInner('<div id="pp_full_res"><div className="pp_inline"></div></div>')
                    .appendTo(e('body'))
                    .show()),
                    (doresize = !1),
                    (g = s(e(myClone).width(), e(myClone).height())),
                    (doresize = !0),
                    e(myClone).remove(),
              ...
              imgPreloader ||
                skipInjection ||
                (($pp_pic_holder.find('#pp_full_res')[0].innerHTML = toInject), p())
            }),
            !1
          )
        }),
        ...
        (e.prettyPhoto.startSlideshow = function () {
          'undefined' == typeof w
            ? ($pp_pic_holder
              ...
              (w = setInterval(e.prettyPhoto.startSlideshow, settings.slideshow)))
        ...
        (e.prettyPhoto.close = function () {
          $pp_overlay.is(':animated') ||
            ...
            0 !== simplePlayer &&
              1 == simplePlayer.prettyPaused &&
              (simplePlayer.play(), (simplePlayer.prettyPaused = 0)))
        }),
