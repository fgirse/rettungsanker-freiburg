...
;(function (audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    flashSource:
      '\
<object classNameid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="$1" width="1" height="1" name="$1" style="position: absolute; left: -2000px;"> \
...
<embed name="$1" src="$2?playerInstance=' +
    ...
    settings: {
      ...
      // The default markup and classNamees for creating the player:
      createPlayer: {
        markup:
          '\
...
<div className="time"> \
<em className="played">00:00</em>/<strong className="duration">00:00</strong> \
</div> \
...
.error .error-message { display: block; }',
    ...
    helpers: {
      ...
      // **Adding/removing className from elements**
