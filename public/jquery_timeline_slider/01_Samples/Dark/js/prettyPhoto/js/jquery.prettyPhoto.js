...
;(function ($) {
      ...
      $pp_pic_holder.fadeIn(function () {
        ...
        switch (_getFileType(pp_images[set_position])) {
          ...
          case 'vimeo':
            ...
            movie =
              'http://player.vimeo.com/video/' + match[2] + '?title=0&amp;byline=0&amp;portrait=0'
            if (settings.autoplay) movie += '&autoplay=1;'
  ...
  function getHashtag() {
    url = location.href
    hashtag =
      url.indexOf('#!') != -1 ? decodeURI(url.substring(url.indexOf('#!') + 2, url.length)) : false
    return hashtag
  }
