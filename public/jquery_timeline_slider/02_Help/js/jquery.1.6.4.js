...
;(function (a, b) {
  ...
  function bW(a, c, d, e, f, g) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l == 'string' &&
          (!k || g[l] ? (l = b) : (c.dataTypes.unshift(l), (l = bW(a, c, d, e, l, g))))
  ...
  function bk(a) {
    f.nodeName(a, 'input')
      ? bj(a)
      : 'getElementsByTagName' in a && f.grep(a.getElementsByTagName('input'), bj)
  }
  function bj(a) {
  ...
  f.extend({
    ...
    acceptData: function (a) {
      if (a.nodeName) {
        ...
        if (b) return b !== !0 && a.getAttribute('classNameid') === b
      }
      return !0
    },
  }),
  ...
  f.fn.extend({
    ...
    f.extend({
      ...
      attr: function (a, c, d, e) {
        ...
        var h,
          ...
          j = g !== 1 || !f.isXMLDoc(a)
        j &&
          ((c = f.attrFix[c] || c), (i = f.attrHooks[c]), i || (t.test(c) ? (i = v) : u && (i = u)))
        if (d !== b) {
          if (d === null) {
            f.removeAttr(a, c)
            return b
    ...
    (v = {
      get: function (a, c) {
        var d
        return f.prop(a, c) === !0 || ((d = a.getAttributeNode(c)) && d.nodeValue !== !1)
          ? c.toLowerCase()
          : b
      },
      set: function (a, b, c) {
  ...
  f.each(['live', 'die'], function (a, c) {
    ...
    (function () {
      ...
      var l = (k.selectors = {
          ...
          leftMatch: {},
          attrMap: { className: 'className', for: 'htmlFor' },
          attrHandle: {
            href: function (a) {
          ...
          filter: {
            ...
            CLASS: function (a, b) {
              return (' ' + (a.className || a.getAttribute('className')) + ' ').indexOf(b) > -1
            },
            ATTR: function (a, b) {
              var c = b[1],
      ...
      c.documentElement.compareDocumentPosition
        ...
        c.querySelectorAll &&
          (function () {
            var a = k,
              ...
              d = '__sizzle__'
            b.innerHTML = "<p className='TEST'></p>"
        ...
        (function () {
          var a = c.createElement('div')
          a.innerHTML = "<div className='test e'></div><div className='test'></div>"
  ...
  ;(f.fn.css = function (a, c) {
    ...
    f.support.opacity ||
      (f.cssHooks.opacity = {
        get: function (a, b) {
          return bn.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || '')
        ...
        ;((d.data && d.hasContent && d.contentType !== !1) || c.contentType) &&
          ...
          v.setRequestHeader(
            ...
            d.dataTypes[0] && d.accepts[d.dataTypes[0]]
              ? d.accepts[d.dataTypes[0]] + (d.dataTypes[0] !== '*' ? ', ' + bT + '; q=0.01' : '')
              : d.accepts['*']
          )
          ...
          ;(c = j ? j.getComputedStyle(b, null) : b.currentStyle),
            ...
            b === d &&
              ...
              f.offset.doesNotAddBorder &&
                (!f.offset.doesAddBorderForTableAndCells || !cs.test(b.nodeName)) &&
